...
% DFez: Dissolved Fe(II) distribution (mol/m3)
% Fe3z: Particulate Fe(III) (FeOOH, Fe(OH)3,Fe2O3...) distribution (mol/m3)
% MFez: Fe(II)-sulfide minerals (FeS,FeS2...) distribution (mol/m3)
% DMnz: Dissolved Mn(II) distribution (mol/m3)
% PMnz: Particulate Manganese dioxides (MnO2) distribution (mol/m3) 
