...
% dt     : Time grid (day) 
% zz     : Depth range (m) 
% Bacz   : Bacteria biomass (cells/m3)
% DOz    : Dissolved oxygen distribution (mol/m3) 
% NH3z   : NH3 distribution (mol/m3)
% NO3z   : NO3 distribution (mol/m3)
% PO4z   : PO4 distribution (mol/m3)
% SO4z   : SO4 distribution (mol/m3)
% H2Sz   : H2S distribution (mol/m3)
% DFez   : Dissolved Fe distribution (mol/m3)
% PFez   : Particulate Fe distribution (mol/m3) 
% DMnz   : Dissolved Mn distribution (mol/m3) 
% PMnz   : Particulate Mn distribution (mol/m3)
% m_p    : Metabolism rate parameter (day-1) in 20 degree C. 
% r_OM   : OM parameter (mol OM/cell) 
