...
[zz,Az,Vz,tt,Qst,Kzt,Tzt,rhozt,DOzt,pHzt,PO4zt,NO3zt,NH3zt,CyBzt,APSBzt,H2Szt,SO4zt,DFezt,PFezt,DMnzt,PMnzt,...
    Qzt_sed,PARzt,Wt,G_cybzt,G_apsbzt] = ...
         odlake_v6(Datetime,Initfile,Initsheet,Inputfile,Inputsheet,Parafile,Parasheet);

%% Input raw dataset 
[Z,T,PAR,DO,pH,PO4,NOx,NH3,CyB,APSB,H2S,SO4,DFe,PFe,DMn,PMn]=rawdatainputs('LakeCadagnoData.xlsx',1);
...
subplot(1,5,2)
plot(NO3zt(:,end)*1000,zz,'b',NOx,Z,'r');
ax=gca;
ax.YDir='reverse';
ax.XAxisLocation='top';
xlabel('NOx (µmol/L)')
