...
function[Z,T,PAR,DO,pH,PO4,NO3,NH3,CyB,APSB,H2S,SO4,DFe,PFe,DMn,PMn]=rawdatainputs(raw_filename,raw_sheet)
...
% NO3: Nitrate profile in the raw dataset (µmol/L)
% NH3: Ammonia profile in the raw dataset (µmol/L) 
