...
[zz,Az,Vz,tt,Qst,Kzt,Tzt,rhozt,DOzt1,pHzt,PO4zt,NO3zt,NH3zt,CyBzt1,APSBzt1,H2Szt,SO4zt,DFezt,PFezt,DMnzt,PMnzt,...
    Qzt_sed,PARzt1,Wt,G_cybzt,G_apsbzt] = odlake_v6_SR_exp(Datetime,Initfile,Initsheet,Inputfile,Inputsheet,Parafile,Parasheet,1);

% Experiment 1 (80%)  

[zz,Az,Vz,tt,Qst,Kzt,Tzt,rhozt,DOzt2,pHzt,PO4zt,NO3zt,NH3zt,CyBzt2,APSBzt2,H2Szt,SO4zt,DFezt,PFezt,DMnzt,PMnzt,...
    Qzt_sed,PARzt2,Wt,G_cybzt,G_apsbzt] = odlake_v6_SR_exp(Datetime,Initfile,Initsheet,Inputfile,Inputsheet,Parafile,Parasheet,0.8);

% Experiment 2 (60%) 

[zz,Az,Vz,tt,Qst,Kzt,Tzt,rhozt,DOzt3,pHzt,PO4zt,NO3zt,NH3zt,CyBzt3,APSBzt3,H2Szt,SO4zt,DFezt,PFezt,DMnzt,PMnzt,...
    Qzt_sed,PARzt3,Wt,G_cybzt,G_apsbzt] = odlake_v6_SR_exp(Datetime,Initfile,Initsheet,Inputfile,Inputsheet,Parafile,Parasheet,0.6);

% Experiment 3 (120%) 

[zz,Az,Vz,tt,Qst,Kzt,Tzt,rhozt,DOzt4,pHzt,PO4zt,NO3zt,NH3zt,CyBzt4,APSBzt4,H2Szt,SO4zt,DFezt,PFezt,DMnzt,PMnzt,...
    Qzt_sed,PARzt4,Wt,G_cybzt,G_apsbzt] = odlake_v6_SR_exp(Datetime,Initfile,Initsheet,Inputfile,Inputsheet,Parafile,Parasheet,1.2);

% Experiment 4 (140%) 

[zz,Az,Vz,tt,Qst,Kzt,Tzt,rhozt,DOzt5,pHzt,PO4zt,NO3zt,NH3zt,CyBzt5,APSBzt5,H2Szt,SO4zt,DFezt,PFezt,DMnzt,PMnzt,...
    Qzt_sed,PARzt5,Wt,G_cybzt,G_apsbzt] = odlake_v6_SR_exp(Datetime,Initfile,Initsheet,Inputfile,Inputsheet,Parafile,Parasheet,1.4);
...
text(-2000,-1.5,'B','FontSize',18,'FontWeight','bold')
...
text(-20000,-1.5,'C','FontSize',18,'FontWeight','bold')

lgd = legend({'Initial' 'Control' 'Q_{sw}-' 'Q_{sw}--' 'Q_{sw}+' 'Q_{sw}++'},'FontSize',14);
...
text(-12,-1.5,'D','FontSize',18,'FontWeight','bold')

saveas(gcf,'Results\SR_experiment.jpg')
